...
public class VexAutonBuilder2 {
		...
		static class DrawingComponent extends JComponent {
			...
			private Point2D lastPoint = new Point2D.Double(50.0,450.0);
			...
			public DrawingComponent(ArrayList<JRadioButton> arr) {
				starts.add(new Point2D.Double(50.0,450.0)); //rf
				starts.add(new Point2D.Double(150.0,550.0)); //rb
	...
	final static private JFrame robotConfigFrame = new JFrame("Robot Configuration");
	...
	*/
	...
	public static void main(String[] args) {
		...
		*/
		...
		//Field Panel--------------------------------------------------------------------------------------------------------------------------
		ImagePanel field = new ImagePanel(new ImageIcon("images/skyrisefield.png").getImage());
